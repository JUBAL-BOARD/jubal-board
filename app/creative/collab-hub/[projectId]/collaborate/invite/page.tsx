...
export default function CollabHubInvitePage() {
    ...
    const handleSendBrief = async () => {
        ...
        try {
            ...
            if (failed.length > 0) {
                ...
                setSentSuccess(true);
                setTimeout(() => {
                    router.push(`/creative/collab-hub/${projectId}/collaborate`);
                }, 1500);
            }
        } catch (err: any) {
                ...
                <main className="flex-1 w-full px-6 lg:px-8 py-6 overflow-y-auto bg-white">
                    <Breadcrumb
                        crumbs={[
                            ...
                            { label: "Collaborate", path: `/creative/collab-hub/${projectId}/collaborate` },
                            { label: "Invite" },
                        ]}
                    />

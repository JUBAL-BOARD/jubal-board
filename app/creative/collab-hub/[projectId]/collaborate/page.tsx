...
export default function CollabHubCollaboratePage() {
                ...
                <main className="flex-1 w-full px-6 lg:px-8 py-6 overflow-y-auto bg-white">
                    <Breadcrumb
                        crumbs={[
                            ...
                            // { label: "View Project", path: `/creative/collab-hub/${projectId}` },
                            { label: "Collaborate" },
                        ]}
                    />
                        ...
                        <div className="w-full lg:w-[300px] shrink-0 flex flex-col gap-4">
                            ...
                            <div className="bg-[#f9f9f9] p-5 rounded-sm border border-gray-100 text-center">
                                ...
                                <div className="flex justify-center mb-4">
                                    <span
                                        className={`inline-block px-5 py-1 text-xs font-semibold rounded-full ${
                                            statusColorMap[detail?.status ?? "IN_PROGRESS"] ?? "bg-yellow-100 text-yellow-700"
                                        }`}
                                    >
                                ...
                                <div className="flex items-center justify-center gap-2 text-sm text-black mt-1">
                                    ...
                                    <span className="text-xs">
                                        Due in {detail?.dueDate ? getDueIn(detail.dueDate) : "2 days  23 hrs  30 mins"}
                                    </span>
                                </div>
                            </div>
                                                ...
                                                >
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        <div className="flex items-center justify-between mt-3">
                                                            <button
                                                                onClick={() => router.push(`/creative/collab-hub/${projectId}`)}
                                                            ...
                                                            <button
                                                                onClick={() => {
                                                                    ...
                                                                    router.push(`/creative/collab-hub/${projectId}/collaborate/invite?collab=${collabData}`);
                                                                }}

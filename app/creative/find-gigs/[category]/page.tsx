...
const CategoryGigsPage: React.FC = () => {
  ...
  const isReady = usePageReady(profileLoading, gigsLoading);
                  ...
                  {filteredGigs.length === 0 ? (
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                      {filteredGigs.map((gig) => (
                        <div
                          key={gig.id}
                          className="bg-white border border-gray-100 overflow-hidden hover:shadow-md transition-shadow group"
                        >

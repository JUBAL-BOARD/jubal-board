...
function useCreativeAvatar(participantId: string, participantName: string) {
...
const ConversationItem: React.FC<{
  ...
  const avatarUrl = useCreativeAvatar(participant.id, participant.name);
...
const ClientConversationList: React.FC<Props> = ({ activeId }) => {
  ...
  const handleSelect = (convo: Conversation) => {
    router.push(`/client/messages/${convo.id}`);
  };

      ...
      >
        ...
        {input.trim() ? (
          <button
            ...
            className="w-8 h-8 bg-[#1a1a2e] hover:bg-[#2a2a4e] rounded-full flex items-center justify-center transition-colors flex-shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {sending ? (

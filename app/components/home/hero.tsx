...
const Hero: React.FC = () => {
  return (
    <div className="relative h-[620px] sm:h-[620px] overflow-hidden">
      {/* Background Image */}
      <Image
        src={herobg}
        alt="hero background"
      ...
      <div className="absolute top-20 sm:top-40 left-4 sm:left-10 right-4 sm:right-10">
        ...
        <div className="flex flex-col sm:flex-row bg-white mt-8 sm:mt-[120px] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.2)] w-full sm:w-[1000px]">
          <div className="flex border-b sm:border-b-0">
            <button className="flex items-center gap-1.5 px-5 py-3 sm:py-0 bg-transparent border-none border-r border-gray-200 cursor-pointer text-sm font-medium text-gray-700 whitespace-nowrap hover:bg-gray-50 transition-colors">
          ...
          />
          <button className="bg-[#E2554F] border-none px-7 py-3.5 sm:py-0 cursor-pointer text-white font-semibold text-[15px] flex items-center justify-center gap-2 hover:bg-[#d44a44] transition-colors">
